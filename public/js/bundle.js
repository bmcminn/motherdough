...
(function () {
    ...
    /* src\client\views\Login.svelte generated by Svelte v3.21.0 */

    const file$1 = "src\\client\\views\\Login.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "placeholder", "sample@email.com");
    			add_location(input0, file$1, 7, 4, 69);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "password");
    			attr_dev(input1, "placeholder", "colour");
    			add_location(input1, file$1, 12, 4, 191);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 16, 4, 277);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "action", "/auth/login");
    			add_location(form, file$1, 6, 0, 23);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\client\layouts\Main.svelte generated by Svelte v3.21.0 */
    const file$2 = "src\\client\\layouts\\Main.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Main Layout";
    			t1 = space();
    			create_component(route.$$.fragment);
    			add_location(h1, file$2, 8, 2, 121);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route: src_5, currentRoute, params });
    ...
    class Main extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currentRoute*/ ctx[0] === undefined && !("currentRoute" in props)) {
    			console.warn("<Main> was created without expected prop 'currentRoute'");
    		}
    	}
    ...
    const routes = [
      { name: '/',      component: Main,    },
      { name: 'login',  component: Login,           layout: Main },
      // {
      //   name: 'admin',
    ...
    /* src\client\App.svelte generated by Svelte v3.21.0 */
    const file$3 = "src\\client\\App.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 8, 0, 128);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router: src_6, routes, name });
