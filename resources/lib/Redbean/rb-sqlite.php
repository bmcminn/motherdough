...
namespace RedBeanPHP\LoggerUtil {

use RedBeanPHP\LoggerUtil as LoggerUtil;
use RedBeanPHP\RedException as RedException;

/**
 * LoggerUtil. Provides a basic logging function for RedBeanPHP.
 *
 * @file    RedBeanPHP/LoggerUtil.php
 * @author  Gabor de Mooij and the RedBeanPHP Community
 * @license BSD/GPLv2
 *
 * @copyright
 ...
 * with this source code in the file license.txt.
 */
class RDefault implements LoggerUtil
{
	/**
	 * LoggerUtil modes
	 */
...
namespace RedBeanPHP\LoggerUtil\RDefault {

use RedBeanPHP\LoggerUtil as LoggerUtil;
use RedBeanPHP\LoggerUtil\RDefault as RDefault;
use RedBeanPHP\RedException as RedException;
 ...
 *
 * @file    RedBeanPHP/LoggerUtil/RDefault/Debug.php
 * @author  Gabor de Mooij and the RedBeanPHP Community
 * @license BSD/GPLv2
 *
 * @copyright
 ...
 * with this source code in the file license.txt.
 */
class Debug extends RDefault implements LoggerUtil
{
	/**
	 * @var integer
	 */
...
interface Driver
{
	 ...
	 * @param LoggerUtil  $logger    logger instance
	 *
	 * @return void
	 */
	public function setDebugMode( $tf, $customLoggerUtil );
...
class RPDO implements Driver
{
	...
	public function setDebugMode( $tf, $logger = NULL )
	{
		...
		$this->setLoggerUtil( $logger );
	}

	/**
	 * Injects LoggerUtil object.
	 ...
	 * query debugger through the facade.
	 *
	 * @param LoggerUtil $logger the logger instance to be used for logging
	 *
	 * @return self
	 */
	public function setLoggerUtil( LoggerUtil $logger )
	{
		$this->logger = $logger;
		return $this;
	}
	...
	/**
	 * Gets LoggerUtil object.
	 * Returns the currently active LoggerUtil instance.
	 *
	 * @return LoggerUtil
	 */
...
use RedBeanPHP\LoggerUtil as LoggerUtil;
use RedBeanPHP\LoggerUtil\RDefault as RDefault;
use RedBeanPHP\LoggerUtil\RDefault\Debug as Debug;
use RedBeanPHP\Adapter as Adapter;
use RedBeanPHP\QueryWriter\AQueryWriter as AQueryWriter;
use RedBeanPHP\RedException as RedException;
...
class Facade
{
  ...
  public static function createToolbox( $dsn = NULL, $username = NULL, $password = NULL, $frozen = FALSE, $partialBeans = FALSE )
  {
	...
	*/
	...
	{
		return self::getLoggerUtil()->getLogs();
	}
	 ...
	 * @return LoggerUtil
	 */
	public static function getLoggerUtil()
	{
		return self::$adapter->getDatabase()->getLoggerUtil();
	}
